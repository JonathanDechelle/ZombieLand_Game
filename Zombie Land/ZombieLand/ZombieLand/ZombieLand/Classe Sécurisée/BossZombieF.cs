...
namespace ZombieLand
{
    class BossZombieF
    {
        ...
        public BossZombieF(Vector2 Position)
        {
            this.Position = Position;
            this.Position = Position;
            RecZombie = new Rectangle((int)Position.X + 40, (int)Position.Y, 80, 60);
            APZ = new AnimationPlayer();
            Walking = new Animation(Ressources.ZombieF, 80, 0.5f, 2, true);
            Dead = new Animation(Ressources.ZombieFDead, 80, 0.1f, 2, false);
            DeadColor = Color.White;
            Argent = 250;
            Vie = new BarreDeVie(Position, 200);
        }
